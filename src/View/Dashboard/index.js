...
const ChatPanel = () => {
  ...
  /**
   * commentData function to get listing of comments and
   *  after condition resolve store listing in state -2 (posts).
   */
  const commentData = () => {
            ...
            <div className="col-md-12 mx-auto">
              ...
              <div className="card">
                ...
                <div className="card-body chat-care">
                  ...
                  {/*
                    *calls a defined callbackfn on each element of an array
                    and returns a new array that contains results
